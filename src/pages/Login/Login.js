...
import { BrowserRouter as Router, Route, Navigate, json } from "react-router-dom";
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch(API_URL2, {
        ...
        body: JSON.stringify({ username,correo:email,nombre:name,apellido:lastname,contraseña:password,code:1}),
      });
        ...
        <div className="row">
          <div className="col-lg-4">
            <figure className="figure pt-5">
              <img
                src={logo}
                className="figure-img img-fluid mb-3"
                alt="..."
              />
...
{/* ---------------------------------Aqui comienza la vista para registrarse ------------------------------- */}
                ...
                <MDBTabsPane show={justifyActive === "tab2"} onSubmit={handleRegister}>
                  <div className="text-center mb-3">
                    <p>Register:</p>
                    {registerError && ( // Mostrar el mensaje de error si el Registro  es incorrecto
                      <div className="alert alert-danger" role="alert">
                         upps, hubo un problema con su registro, Intentelo Nuevamente
                      </div>
                    )}
                  ...
                  <MDBBtn className="btn-back mb-4 w-100"
